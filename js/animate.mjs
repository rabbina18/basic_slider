...
export default class Animate {
    constructor(selector, option){
        ...
        if(this.isString === 'string') {
            ...
            const y = ['margin-right', 'margin-bottom', 'top', 'bottom', 'height'];
    
            for(let condition of x){
                if(option.prop === condition) this.currentValue = (this.currentValue/parentW)*100;
            }
            for(let condition of y){
                if(option.prop === condition) this.currentValue = (this.currentValue/parentH)*100;
            }
